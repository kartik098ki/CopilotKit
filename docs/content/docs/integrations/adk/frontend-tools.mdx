...
Frontend tools enable you to define client-side functions that your ADK agent can invoke, with execution happening
...
This can be utilized for to let [your agent control the UI](/adk/frontend-tools), [generative UI](/adk/frontend-tools),
or for Human-in-the-loop interactions.
