...
The Built-in Agent uses the [Vercel AI SDK](https://sdk.vercel.ai) under the hood, giving you access to models from
OpenAI, Anthropic, and Google — plus the ability to use any custom AI SDK model.
