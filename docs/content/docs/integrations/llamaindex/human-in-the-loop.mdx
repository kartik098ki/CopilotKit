...
Frontend tools enable you to define client-side functions that your LlamaIndex agent can invoke, with execution
...
This can be utilized to let [your agent control the UI](/llamaindex/frontend-tools),
[generative UI](/llamaindex/frontend-tools), or for Human-in-the-loop interactions.
