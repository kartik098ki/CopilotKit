...
By default, the Pydantic AI Agent state will only update _between_ Pydantic AI Agent node transitions -- which means
state updates will be discontinuous and delayed.
