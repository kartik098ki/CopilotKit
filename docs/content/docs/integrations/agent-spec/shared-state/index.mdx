...
Agent Spec agentic chat supports streaming text and tool events. For advanced shared state patterns, mirror what you
surface as messages or tool calls until a dedicated state channel is available.
