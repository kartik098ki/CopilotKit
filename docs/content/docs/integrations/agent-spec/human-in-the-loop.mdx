...
Frontend tools enable you to define client-side functions that your Agent Spec agent can invoke, with execution
...
This can be utilized to let [your agent control the UI](/agent-spec/frontend-tools),
[generative UI](/agent-spec/frontend-tools), or for Human-in-the-loop interactions.
