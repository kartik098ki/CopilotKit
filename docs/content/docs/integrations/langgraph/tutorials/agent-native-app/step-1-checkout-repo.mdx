...
Visit [http://localhost:3000](http://localhost:3000) to see the initial application. You'll see an empty chat interface
and document - this is our starting point.
