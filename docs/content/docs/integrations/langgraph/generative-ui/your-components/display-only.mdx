...
`useComponent` lets you register a React component as a tool your agent can invoke. When the agent calls the tool,
CopilotKit renders your component directly in the chat with the tool's arguments as props.

This is the simplest form of Generative UI — your agent decides when to show a component, and CopilotKit renders it. No
handler logic, no user interaction required.
...
For components that need user interaction, see [Interactive](/langgraph/generative-ui/your-components/interactive) or
[Interrupt-based](/langgraph/generative-ui/your-components/interrupt-based).
