...
Frontend tools enable you to define client-side functions that your Agno agent can invoke, with execution happening
...
This can be utilized for to let [your agent control the UI](/agno/frontend-tools),
[generative UI](/agno/frontend-tools), or for [Human-in-the-loop](/agno/human-in-the-loop) interactions.
