...
Tools are a way for the LLM to call predefined, typically deterministic functions. CopilotKit allows you to render these
tools in the UI as a custom component, which we call **Generative UI**.
      ...
      if (status === "executing") {
        return (
          <div className="p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-600">Getting weather for {args.location}...</p>
          </div>
        );
      }
      ...
      if (status === "complete" && result) {
        ...
        return (
          <div className="p-4 bg-white border rounded-lg shadow-sm">
            <h3 className="font-semibold text-lg mb-2">Weather in {args.location}</h3>
