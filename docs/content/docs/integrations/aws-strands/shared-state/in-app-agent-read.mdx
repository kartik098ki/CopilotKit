...
You can also render the agent state in the chat UI. This is useful for informing the user about the state in a more
in-context way. To do this, you can use the `useAgent` hook with a `render` function.
