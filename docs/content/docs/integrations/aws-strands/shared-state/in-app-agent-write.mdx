...
You can easily write to your agent's state from your native application, allowing you to update the agent's state from
your UI.

## When should I use this?

You can use this when you want to provide user input or control to your agent's state. As your application state
changes, you can update the agent state to reflect these changes.
