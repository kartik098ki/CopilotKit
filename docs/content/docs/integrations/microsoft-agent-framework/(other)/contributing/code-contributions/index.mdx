...
{/* TODO: Add the MAF equivalent of this section. */} {/\* ## Starting a dev environment with hot reload

CopilotKit contains a ready-made script for starting a development environment based on one of the agent examples. It
lets you work on CopilotKit internals in the core Typescript, Python, or .NET code, respectively, while seeing your
changes applied to the chosen example.
