...
Frontend tools enable you to define client-side functions that your Mastra agent can invoke, with execution happening
...
This can be utilized to let [your agent control the UI](/mastra/frontend-tools),
[generative UI](/mastra/frontend-tools), or for Human-in-the-loop interactions.
