...
You can use this when you want to provide the user with feedback about what your working memory. As your agent's state
...
You can also render the working memory in the chat UI. This is useful for informing the user about the working memory in
a more in-context way. To do this, you can use the `useAgent` hook with a `render` function.
