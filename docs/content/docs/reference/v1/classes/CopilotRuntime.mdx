...
- packages/v1/runtime/src/lib/runtime/copilot-runtime.ts \*/ }
  <Callout type="info">
    This is the reference for the `CopilotRuntime` class. For more information and example code snippets, please see
    [Copilot Runtime](/built-in-agent/copilot-runtime).
  </Callout>
