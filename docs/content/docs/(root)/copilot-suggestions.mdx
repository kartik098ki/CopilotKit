...
Chat suggestions let you auto-generate contextual actions in the chat window based on real-time application state. The
agent proposes relevant next steps that users can tap to execute instantly.
