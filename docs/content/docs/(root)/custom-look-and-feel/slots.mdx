...
Slots let you customize CopilotKit's pre-built chat components without building everything from scratch. Override
specific parts of the UI — message bubbles, input areas, headers — while keeping the rest of the default behavior.
