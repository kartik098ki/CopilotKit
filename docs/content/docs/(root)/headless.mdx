...
CopilotKit's headless hooks give you complete control over the chat experience — manage messages, streaming, and tool
calls with zero UI opinions. Bring your own design system and render everything your way.
...
export default function Chat() { const { run, messages, isRunning } = useAgent();
