In this guide, we'll teach you how to link the CopilotKit packages to your own project to test your changes. This way,
you can run `turbo run dev` in the CopilotKit monorepo, and see changes in your own project immediately.

## Global Package Linking With `pnpm`

We will use pnpm's [global linking feature](https://pnpm.io/cli/link#pnpm-link---global) to link the CopilotKit packages
to your own project.
