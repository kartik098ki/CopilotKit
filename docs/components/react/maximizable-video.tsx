  ...
  return (
    <>
      <div className={`relative group ${className}`}>
        ...
        <video src={src} autoPlay loop muted playsInline className="relative rounded-2xl w-full" />
        <button
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative max-w-4xl w-full">
            ...
            <video src={src} autoPlay loop muted playsInline className="rounded-2xl w-full" />
          </div>
        </div>
      )}
    </>
